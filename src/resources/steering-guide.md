...
**File Operations**:
- **CRITICAL: Check for custom template FIRST:** `.spec-workflow/user-templates/product-template.md`
- Read template: `.spec-workflow/templates/product-template.md` (ONLY if no custom template)
...
2. **CRITICAL: Check for custom template FIRST at `.spec-workflow/user-templates/product-template.md`**
3. If custom template exists, use it; otherwise read from `.spec-workflow/templates/product-template.md`
...
**File Operations**:
- **CRITICAL: Check for custom template FIRST:** `.spec-workflow/user-templates/tech-template.md`
- Read template: `.spec-workflow/templates/tech-template.md` (ONLY if no custom template)
...
**Process**:
1. **CRITICAL: Check for custom template FIRST at `.spec-workflow/user-templates/tech-template.md`**
2. If custom template exists, use it; otherwise read from `.spec-workflow/templates/tech-template.md`
...
**File Operations**:
- **CRITICAL: Check for custom template FIRST:** `.spec-workflow/user-templates/structure-template.md`
- Read template: `.spec-workflow/templates/structure-template.md` (ONLY if no custom template)
...
**Process**:
1. **CRITICAL: Check for custom template FIRST at `.spec-workflow/user-templates/structure-template.md`**
2. If custom template exists, use it; otherwise read from `.spec-workflow/templates/structure-template.md`
